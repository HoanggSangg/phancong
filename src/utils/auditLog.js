...
const ROUTE_RULES = [
  ...
  { pattern: /^\/api\/wokers\/create$/, method: 'POST', action: 'create', module: 'woker', label: 'Tạo công việc thợ' },
  { pattern: /^\/api\/wokers\/[^/]+$/, method: 'PUT', action: 'update', module: 'woker', label: 'Cập nhật công việc thợ' },
  { pattern: /^\/api\/wokers\/[^/]+$/, method: 'DELETE', action: 'delete', module: 'woker', label: 'Xóa công việc thợ' },
