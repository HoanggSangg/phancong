...
const logTrimResults = (results, summary) => {
  ...
  console.log(`   RepairOrderItem max ${summary.repairItemMax} | Wokers max ${summary.wokersMax}`);
  console.log(`   OperationLog >${summary.operationLogDays} ngày | Bỏ qua: ${summary.skip.join(', ')}`);
